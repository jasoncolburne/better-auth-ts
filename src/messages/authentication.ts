...
export class BeginAuthenticationRequest extends SerializableMessage implements IBeginAuthenticationRequest {
    constructor(
        public payload: {
            identification: {
                accountId: string
...
export class BeginAuthenticationResponse extends SignableMessage implements IBeginAuthenticationResponse {
    constructor(
        public payload: {
            authentication: {
                nonce: string
...
export class CompleteAuthenticationRequest extends SignableMessage implements ICompleteAuthenticationRequest {
    constructor(
        public payload: {
            identification: {
                deviceId: string
...
export class CompleteAuthenticationResponse extends SignableMessage implements ICompleteAuthenticationResponse {
    constructor(
        public payload: {
            refresh: {
                sessionId: string,
...
export class BeginPassphraseAuthenticationRequest extends SerializableMessage implements IBeginPassphraseAuthenticationRequest {
    constructor(
        public payload: {
            identification: {
                accountId: string
...
export class BeginPassphraseAuthenticationResponse extends SignableMessage implements IBeginPassphraseAuthenticationResponse {
    constructor(
        public payload: {
            passphraseAuthentication: {
                nonce: string,
...
export class CompletePassphraseAuthenticationRequest extends SignableMessage implements ICompletePassphraseAuthenticationRequest {
    constructor(
        public payload: {
            passphraseAuthentication: {
                nonce: string
...
export class CompletePassphraseAuthenticationResponse extends SignableMessage implements ICompletePassphraseAuthenticationResponse {
    constructor(
        public payload: {
            refresh: {
                sessionId: string,
