...
export class RotateAuthenticationKeyRequest extends SignableMessage implements IRotateAuthenticationKeyRequest {
    constructor(
        public payload: {
            identification: {
                accountId: string
...
export class RotateAuthenticationKeyResponse extends SignableMessage implements IRotateAuthenticationKeyResponse {
    constructor(
        public payload: {
            success: boolean,
            publicKeyDigest: string
